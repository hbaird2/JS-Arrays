...
function divider(numbersArray) {
  ...
  // var dividedArray =[];
  // dividedArray.push(evenArray);
  // dividedArray.push(oddArray);
  // return dividedArray;
}
...
function removeItem(myGroceryList, itemToRemove) {
  ...
  for (var i = 0; i < myGroceryList.length; i++) {
    ...
    // else if (typeof itemToRemove === "undefined" || itemToRemove === null || itemToRemove === "") {
    //  return [];
    // }
  }
...
for (var obj in devMountainEmployees) {
  console.log(devMountainEmployees[obj]);
}
...
var user2 = {
    name: 'Hunter Baird',
    email: 'hunterwbaird@gmail.com',
    password: 'StarWars',
    username: 'BurlyTardigrade'
};
